    ...
    <form>
      ...
      <fieldset>
        ...
        <div>
          ...
          <input type="text" v-model="methodInfo.methodName" />
        </div>
        <div>
          <label>URL</label>
          <input type="text" v-model="methodInfo.url" />
        </div>
        <div>
          <label>username</label>
          <input type="text" v-model="methodInfo.username" />
        </div>
        <div>
          <label>password</label>
          <input type="text" v-model="methodInfo.password" />
        </div>
        <div>
          <label>Notes</label>
          <textarea
